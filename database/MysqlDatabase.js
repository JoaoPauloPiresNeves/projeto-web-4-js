...
/**
 * Classe responsável por gerenciar a conexão com o banco MySQL/MariaDB.
 * 
...
module.exports = class MysqlDatabase {
     ...
     *   waitForConnections, connectionLimit, queueLimit, charset
     * }
     */
    constructor(config = {}) {
        ...
        this.#database = config.database || "pjt2b";
    ...
    async connect() {
        if (!MysqlDatabase.#pool) {
            ...
            try {
                ...
                console.log("✅ Conectado ao banco pjt2b (MySQL/MariaDB)");
                connection.release();
            } catch (error) {
